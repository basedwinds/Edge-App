...
import { RacingFutures } from "./pages/RacingFutures";
...
import { CfbDashboard } from "./pages/CfbDashboard";
import { CfbRecommended } from "./pages/CfbRecommended";
import { CfbPlaced } from "./pages/CfbPlaced";
import { CfbCalibration } from "./pages/CfbCalibration";
...
import { CodRecommended } from "./pages/CodRecommended";
import { CodPlaced } from "./pages/CodPlaced";
import { CodCalibration } from "./pages/CodCalibration";
  ...
  return (
    <div className="flex h-full">
      ...
      <Routes>
        ...
        <Route path="/cfb/recommended" element={<CfbRecommended />} />
        <Route path="/cfb/placed" element={<CfbPlaced />} />
        <Route path="/cfb/calibration" element={<CfbCalibration />} />
        ...
        <Route path="/cod/recommended" element={<CodRecommended />} />
        <Route path="/cod/placed" element={<CodPlaced />} />
        <Route path="/cod/calibration" element={<CodCalibration />} />
        ...
        <Route path="/racing/:series/futures" element={<RacingFutures />} />
